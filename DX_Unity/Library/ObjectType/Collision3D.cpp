...
// 点と点
bool Collision3D::CollisionPointandPoint( GameObject* pPoint, GameObject* pPoint2 ) {
...
// 点と円
bool Collision3D::CollisionPointandCircle( GameObject* pPoint, GameObject* pCircle ){
...
// 円と円
bool Collision3D::CollisionCircleandCircle( GameObject* pCircle, GameObject* pCircle2 ){
...
// 箱と点
bool Collision3D::CollisionCubeandPoint( GameObject* pCube, GameObject* pPoint ) {
...
// 箱と箱
bool Collision3D::CollisionCubeandCube( GameObject* pCube, GameObject* pCube2 ) {
	
	// あまりに遠いオブジェクトは判定外に
	float fDistance;
	float fDistanceX = pCube->GetPosition()->x - pCube2->GetPosition()->x;
	float fDistanceY = pCube->GetPosition()->y - pCube2->GetPosition()->y;
	float fDistanceZ = pCube->GetPosition()->z - pCube2->GetPosition()->z;
...
// 箱と円
bool Collision3D::CollisionCubeandCircle( GameObject* pCube, GameObject* pCircle ) {
...
// OBBとOBBの当たり判定
bool Collision3D::CollisionOBBandOBB( GameObject* pObb, GameObject* pObb2 ) {
...
FLOAT Collision3D::LenSegOnSeparateAxis( D3DXVECTOR3 *Sep, D3DXVECTOR3 *e1, D3DXVECTOR3 *e2, D3DXVECTOR3 *e3 )
{
...
// OBBに必要な情報をセット
OBB Collision3D::SetOBB( GameObject* pObb ) {
